...
Future<String> compareBeatsToClustur({
            ...
            if (toSave != "" && saveFrom != "") {
              ...
              await Directory(toSave
                ...
                File(saveFrom)
                  ...
                  String consoleData = "Custer failed $unsuccessful with $toSave and $saveFrom";
                  addConsole(consoleData);
                  print(
  ...
  String successInfo= "$counter were successful and $unsuccessful were unsuccessful... Process Again";
